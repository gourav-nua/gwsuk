    ...
    public function aroundExecute(
        ...
        switch ($section) {
            ...
            case $this->reader('YXRobGV0ZTJfZGVzaWdu'):
                ...
                if ($object) {
                    $date = (int)$object->getModuleConfig( $this->reader('Z2VuZXJhbC9pbnN0YWxsX2RhdGU='), 0,
                ...
                break;
            case $this->reader('b2xlZ25heF9pbnN0YWdyYW0='):
            case $this->reader('b2xlZ25heF9pbnN0YWdyYW1fYXBwZWFyYW5jZQ=='):
